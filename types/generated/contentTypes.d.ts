...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tour categories like Train Tour, City Experiences, etc.';
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Travel tour listing';
    displayName: 'Tour';
    pluralName: 'tours';
    singularName: 'tour';
  };
  ...
  attributes: {
    availability: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Available year-round'>;
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currency: Schema.Attribute.Enumeration<['USD', 'CNY']> &
    ...
    duration_days: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    end_city: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    ...
    is_waitlist: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    specific_dates: Schema.Attribute.Text;
    start_city: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
...
export interface ApiTypeType extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tour type filter like Expert-led journeys, Small Group Departures, etc.';
